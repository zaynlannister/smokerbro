...
export default async function MenuLayout({ children }: { children: ReactNode }) {
  const setting = await prisma.setting.findUnique({ where: { key: "instagram_url" } });
  const instagramUrl = setting?.value || "";
        ...
        <div className="flex items-center justify-between">
          ...
          {instagramUrl && (
            <a
              ...
              className="flex items-center justify-center text-cream-dark transition-colors hover:text-gold active:text-gold"
            >
